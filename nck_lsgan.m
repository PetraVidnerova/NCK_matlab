...
save gen_lsgan_GPU.mat generator
...
% Quadratic loss.
g_loss = l2_loss(d_output_fake - 1);
d_loss_real = l2_loss(d_output_real - 1);
d_loss_fake = l2_loss(d_output_fake);
